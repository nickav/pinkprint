...
module.exports = (src, dest, name, argv = {}) => {
  ...
  pinkprint.metalsmith.metadata(pinkprint.context)
  ...
  // lastly, print all files that will be generated
  pinkprint.metalsmith.use(files => {
    argv.verbose && console.log()
    Object.keys(files).forEach(file => console.log(`  create ${file}`))
  })
